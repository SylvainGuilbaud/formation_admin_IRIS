$(document).ready(function () {
    ...
    var objPatient = "";
     ...
     // ---- BASIC AUTH (simple) ----
    const username = sessionStorage.getItem("fhir_basic_user") || prompt("FHIR username:");
    const password = sessionStorage.getItem("fhir_basic_pass") || prompt("FHIR password:");
    sessionStorage.setItem("fhir_basic_user", username);
    sessionStorage.setItem("fhir_basic_pass", password);
